...
[Flowmotion](https://github.com/ZhiXin18/flowmotion) is a mobile application developed to help Singaporean drivers navigate traffic more efficiently by providing real-time congestion data. Leveraging live traffic camera feeds and machine learning models, the app analyzes road congestion and offers optimized route recommendations. The goal of Flowmotion is to minimize commuter stress and time spent in traffic, providing users with a seamless and personalized experience to plan their daily commutes.
