...
- **Storage** parsing Tab Separated Values (TSV) data file, organising data into columar format sorted by key and storing it into fixed-sized data blocks on disk.
